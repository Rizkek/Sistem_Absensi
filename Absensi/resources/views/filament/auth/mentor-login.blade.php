        ...
        <div class="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden shrink-0">
            ...
            <div class="relative z-10 flex flex-col justify-center px-16 text-white w-full h-full">
                <div class="mb-12">
                    ...
                    <h1 class="text-4xl font-semibold mb-3 tracking-tight text-white">Portal Pembimbing</h1>
                ...
                <div class="space-y-4 max-w-sm">
                    <div class="flex items-center gap-3 text-slate-300">
                        ...
                        <p class="text-sm">Kelola sesi halaqah</p>
                    </div>
                    <div class="flex items-center gap-3 text-slate-300">
                        <div class="w-1.5 h-1.5 rounded-full bg-emerald-400"></div>
                        <p class="text-sm">Input kehadiran</p>
                    </div>
                    <div class="flex items-center gap-3 text-slate-300">
                        <div class="w-1.5 h-1.5 rounded-full bg-emerald-400"></div>

                        <p class="text-sm">Monitor progres</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden mb-10 text-center">
                    <h1 class="text-2xl font-bold text-slate-900">Portal Pembimbing</h1>
                    <p class="text-sm text-slate-500 mt-1">Mentor Access</p>
                </div>

                {{-- Form Header --}}
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-slate-900 mb-2">Sign In</h2>
                    <p class="text-slate-500 text-sm">Masuk ke dashboard mentor</p>
                </div>
